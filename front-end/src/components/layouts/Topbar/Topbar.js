...
import { titleState } from "../../../storages/index";
import { useRecoilValue } from "recoil";

const LayoutsTopbar = () => {
  const title = useRecoilValue(titleState);
  const navtitle = title.toUpperCase();
      ...
      <div className="app-container container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div className="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
          <Link to="/" className="d-lg-none">
            {/* <img alt="Logo" src="https://manajemen-alfaprima.com/img/Alfa Prima Logo.png" className="h-30px" /> */}
          </Link>
        </div>
        {/*end::Mobile logo*/}
        ...
        <div className="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
          ...
          <div className="app-header-menu app-header-mobile-drawer align-items-stretch">
            ...
            <div className="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu">
              <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" className="menu-item menu-lg-down-accordion me-0 me-lg-2">
                {/*begin:Menu link*/}
                <span>
                  {/* <Link className="nav-link active" aria-current="page" to="/" onClick={() => setMenuMobile(false)}> */}
                  <span style={{ fontWeight: "bold" }} className="text-muted fw-semibold me-1 menu-title">
                    {navtitle}
                  </span>
          ...
          <div className="app-navbar flex-shrink-0">
            ...
            <div className="app-navbar-item ms-1 ms-lg-3">
              ...
              >
                {/*begin::Svg Icon | THEME |path: icons/duotune/general/gen060.svg*/}
                ...
                {/*end::Svg Icon THEME*/}
                {/*begin::Svg Icon | LOG OUT |path: icons/duotune/general/gen061.svg*/}
              ...
              >
                ...
                <div className="menu-item px-3 my-0">
                  <Link to="#" className="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="light">
                    <span className="menu-icon" data-kt-element="icon">
                      {/*begin::Svg Icon | LIGHT ICON |path: icons/duotune/general/gen060.svg*/}
                ...
                {/*begin::Menu item 2*/}
                <div className="menu-item px-3 my-0">
                  <Link to="#" className="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="dark">
                    <span className="menu-icon" data-kt-element="icon">
                      {/*begin::Svg Icon | DARK ICON |path: icons/duotune/general/gen061.svg*/}
                      <span className="svg-icon svg-icon-3">
                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M19.0647 5.43757C19.3421 5.43757 19.567 5.21271 19.567 4.93534C19.567 4.65796 19.3421 4.43311 19.0647 4.43311C18.7874 4.43311 18.5625 4.65796 18.5625 4.93534C18.5625 5.21271 18.7874 5.43757 19.0647 5.43757Z"
            ...
            {/*begin::Logout*/}
            <div className="app-navbar-item ms-5 ms-lg-7">
              {/*begin::Drawer toggle*/}
              <div className="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-70px h-35px w-md-100px h-md-40px">
                <span className="svg-icon svg-icon-1">
                  <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" className="menu-item menu-lg-down-accordion me-0 me-lg-0">
                    <span className="menu-link">
                      <Link /*onClick={handleLogout}*/ className="nav-link active" aria-current="page" to="/">
                        <span className=" fa fa-sign-out-alt ">{"\u00a0"}Log Out</span>
                      </Link>
                    </span>
                  </div>
                </span>
